...
class TestWarmCache(unittest.TestCase):
    ...
    def test_warm_cache_custom_methods(self):
        ...
        with patch.object(self.repository, 'branches', return_value=Mock()) as mock_branches, \
             patch.object(self.repository, 'tags', return_value=Mock()) as mock_tags:
    ...
    def test_warm_cache_method_failure(self):
        ...
        with patch.object(self.repository, 'branches', side_effect=Exception("Git error")) as mock_branches, \
             patch.object(self.repository, 'tags', return_value=Mock()) as mock_tags:
    ...
    def test_warm_cache_all_methods_fail(self):
        ...
        with patch.object(self.repository, 'branches', side_effect=Exception("Error 1")), \
