...
def demonstrate_repository_fetch_and_warm():
    ...
    custom_warm_result = repo.warm_cache(
        methods=['commit_history', 'branches', 'file_detail'],
        limit=20,
    ...
    start_time = time.time()
    commit_history_cold = repo.commit_history(limit=50)
    ...
    start_time = time.time()
    commit_history_warm = repo.commit_history(limit=50)
...
def demonstrate_persistent_cache_with_fetch():
    ...
    start_time = time.time()
    commit_history = repo2.commit_history(limit=50)
