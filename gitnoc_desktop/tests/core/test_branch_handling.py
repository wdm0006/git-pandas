...
class TestBranchHandling(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.branches_df = pd.DataFrame({
            'branch': ['main', 'develop', 'feature/test', 'gh-pages'],
    ...
    def test_fetch_overview_with_nonexistent_branch(self):
        ...
        commit_history_calls = [args[1] for args, _ in self.mock_repo.commit_history.call_args_list 
    ...
    def _mock_commit_history(self, branch=None, limit=None, days=None, ignore_globs=None, include_globs=None, force_refresh=False):
