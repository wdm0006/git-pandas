...
class TestPunchcard:
    def test_punchcard_basic(self, local_repo):
        ...
        punchcard = local_repo.punchcard(branch='main')
    ...
    def test_punchcard_normalize(self, local_repo):
        ...
        punchcard_norm = local_repo.punchcard(branch='main', normalize=1.0)
    ...
    def test_punchcard_by_parameter(self, local_repo):
        ...
        punchcard_committer = local_repo.punchcard(branch='main', by='committer')
        
        # Check that we have the committer column
        assert 'committer' in punchcard_committer.columns
        
        # Test with by='repository'
        punchcard_repo = local_repo.punchcard(branch='main', by='repository')
    ...
    def test_punchcard_with_globs(self, local_repo):
        ...
        punchcard_all = local_repo.punchcard(branch='main')
        
        # Get punchcard ignoring Python files
        punchcard_no_py = local_repo.punchcard(branch='main', ignore_globs=['*.py'])
        ...
        punchcard_only_py = local_repo.punchcard(branch='main', include_globs=['*.py'])
    ...
    def test_punchcard_with_limit(self, local_repo):
        ...
        punchcard_limited = local_repo.punchcard(branch='main', limit=3)
    ...
    def test_punchcard_with_days(self, local_repo):
        ...
        punchcard_recent = local_repo.punchcard(branch='main', days=2)
